...
test.describe('Session Validation using Stored Authentication from tests file', () => {
  ...
  test('Verify Admin can see the room management list', { tag: ['@booker'] }, async ({ Given, Then, And, page }) => { 
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":6,"pickleLine":4,"tags":["@booker"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given I am on the Booker Admin dashboard","stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":6,"keywordType":"Outcome","textWithKeyword":"Then I should see the \"Rooms\" management section","stepMatchArguments":[{"group":{"start":17,"value":"\"Rooms\"","children":[{"start":18,"value":"Rooms","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":9,"gherkinStepLine":7,"keywordType":"Outcome","textWithKeyword":"And the \"Logout\" button should be visible","stepMatchArguments":[{"group":{"start":4,"value":"\"Logout\"","children":[{"start":5,"value":"Logout","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end